...
_SPECIFICATION = _descriptor.Descriptor(
  ...
  nested_types=[_SPECIFICATION_ECDSA, _SPECIFICATION_RSA, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
PEMKeyFile = _reflection.GeneratedProtocolMessageType('PEMKeyFile', (_message.Message,), dict(
...
PKCS11Config = _reflection.GeneratedProtocolMessageType('PKCS11Config', (_message.Message,), dict(
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z(github.com/google/trillian/crypto/keyspb'))
