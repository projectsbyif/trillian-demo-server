...
_SIGNEDLOGROOT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='timestamp_nanos', full_name='trillian.SignedLogRoot.timestamp_nanos', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_hash', full_name='trillian.SignedLogRoot.root_hash', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tree_size', full_name='trillian.SignedLogRoot.tree_size', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tree_revision', full_name='trillian.SignedLogRoot.tree_revision', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='key_hint', full_name='trillian.SignedLogRoot.key_hint', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log_root', full_name='trillian.SignedLogRoot.log_root', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log_root_signature', full_name='trillian.SignedLogRoot.log_root_signature', index=6,
...
SignedEntryTimestamp = _reflection.GeneratedProtocolMessageType('SignedEntryTimestamp', (_message.Message,), dict(
...
SignedLogRoot = _reflection.GeneratedProtocolMessageType('SignedLogRoot', (_message.Message,), dict(
...
SignedMapRoot = _reflection.GeneratedProtocolMessageType('SignedMapRoot', (_message.Message,), dict(
...
_TREESTATE.values_by_name["DEPRECATED_SOFT_DELETED"].has_options = True
_TREESTATE.values_by_name["DEPRECATED_SOFT_DELETED"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\010\001'))
_TREESTATE.values_by_name["DEPRECATED_HARD_DELETED"].has_options = True
_TREESTATE.values_by_name["DEPRECATED_HARD_DELETED"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\010\001'))
